...
// Internal Components
import AcceptProjectInvitationClient from "@/components/features/auth/AcceptProjectInvitationClient";
...
/**
 * Trang tiep nhan loi moi vao du an (Accept Project Invitation Page).
 * Su dung Suspense de bao boc Client Component, cho phep xu ly logic xac thuc token tu URL.
 */
                        ...
                        <div className="p-16 text-center flex flex-col items-center justify-center gap-4">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-[12px] font-medium text-slate-400">
                                    Checking project access rights...
                                </p>
                            </div>
                        </div>
                    }
                >
                    {/* Component xu ly logic chap nhan loi moi vao du an phia Client */}
                    <AcceptProjectInvitationClient />
                </Suspense>
            </div>
