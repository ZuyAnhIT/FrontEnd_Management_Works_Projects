...
export default function ProfileSettingsPage() {
    ...
    useEffect(() => {
        if (user) {
            setForm({
                ...
                // Cắt chuỗi ngày giờ nếu API trả về ISO string
    ...
    // =================================================================
    // 2️⃣ XỬ LÝ CHỌN FILE ẢNH (Logic nghiệp vụ quan trọng)
    // =================================================================
    ...
    // =================================================================
    // 3️⃣ XỬ LÝ SUBMIT FORM (Logic nghiệp vụ quan trọng)
    // =================================================================
                ...
                <div className="p-8 bg-slate-50/50 border-b border-slate-100 flex flex-col sm:flex-row items-center gap-8">
                    ...
                    >
                        <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-full border-[4px] border-white shadow-md overflow-hidden bg-slate-200 relative">
                            ...
                            {/* Hiển thị icon User nếu ảnh lỗi */}
                            {/* Dùng class image-error để xử lý hiển thị fallback icon */}
