...
// Hàm tiện ích xử lý URL ảnh (Giữ nguyên logic)
...
export default function WorkspaceSettingsPage() {
    ...
    // ===================================================
    // 1. LOAD DATA (Logic nghiệp vụ quan trọng)
    // ===================================================
    useEffect(() => {
    ...
    const handleDeleteConfirm = async () => {
        ...
        try {
            ...
            // Quan trọng: Điều hướng sau khi xóa thành công
                        ...
                        <CardContent className="p-6 space-y-5">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Input
                                    ...
                                    onChange={(e) =>
                                        handleChange("workspaceName", e.target.value)
                                    }
                            ...
                            <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center p-4 bg-slate-50 rounded-lg border border-dashed border-slate-200">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-xs text-slate-500 max-w-xs">
                                        Recommended size: 1200x300px. <br /> Supports JPG, PNG. Max
                                        5MB.
                                    </p>
                                    <input
                                        type="file"
                        ...
                        <CardContent className="p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                            <div>
                                ...
                                <p className="text-xs text-slate-500 mt-1 max-w-md">
                                    ...
                                    projects and tasks inside will be permanently removed.
                                </p>
                            </div>
                            <Button
                                type="button"
