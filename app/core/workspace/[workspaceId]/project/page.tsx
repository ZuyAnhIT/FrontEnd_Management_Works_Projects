           ...
           <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto items-center">
               ...
               <div className="flex bg-slate-100 p-1 rounded-md border border-slate-200">
                   <button
                      ...
                      className={`px-4 py-1.5 rounded-sm text-sm font-medium transition-all flex items-center gap-2 ${
                   ...
                   <button
                      ...
                      className={`px-4 py-1.5 rounded-sm text-sm font-medium transition-all flex items-center gap-2 ${
                          activeTab === "trash" ? "bg-white text-red-600 shadow-sm" : "text-slate-600 hover:text-slate-900"
                      }`}
                   >
