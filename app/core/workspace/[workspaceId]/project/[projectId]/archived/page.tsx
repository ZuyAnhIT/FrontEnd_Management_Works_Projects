...
export default function ArchivedPage() {
    ...
    const fetchTasks = useCallback(async () => {
        ...
        try {
            ...
            const message = error.response?.data?.message || error.message || "Failed to load archived tasks";
    ...
    const confirmRestore = async () => {
        ...
        try {
            ...
            console.error(error);
            const message = error.response?.data?.message || error.message || "Failed to restore task. Please try again.";
            showToast(message, "error");
        } finally {
