...
import { Loader2, PieChart as PieIcon, Bug, Bookmark, CheckSquare, Layers, LucideIcon } from "lucide-react";
...
const getTypeIcon = (code?: string): React.ReactNode => {
    switch (code) {
                        ...
                        <Legend 
                            ...
                            formatter={(value, entry: any) => (
                                <span className="text-xs text-slate-600 font-medium ml-1">
                                    {entry.payload.code ? getTypeIcon(entry.payload.code) : null}
