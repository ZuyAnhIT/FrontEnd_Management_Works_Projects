...
import { Filter, Calendar as CalendarIcon, X, Layers, Clock, Zap, Download, FileSpreadsheet } from "lucide-react";
...
export default function WorkloadFilterToolbar({ 
  ...
  const clearFilters = () => {
    setFilters({ viewType: "POINTS", groupBy: "STATUS" });
  };
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 mb-6 bg-slate-50/50 p-3 rounded-xl border border-slate-200 shadow-sm">
        ...
        {/* ... (Giữ nguyên phần View Type, Group By, Sprint Selector, Date Range cũ của bạn) ... */}
        ...
        <div className="relative">
            ...
            <select 
                className="h-9 pl-9 pr-8 border border-slate-200 rounded-lg text-sm bg-white text-slate-600 focus:border-blue-500 outline-none cursor-pointer font-medium hover:border-blue-300 transition-colors"
