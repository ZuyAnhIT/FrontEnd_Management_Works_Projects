...
import { Plus, ChevronDown, ChevronRight, Sparkles, List, CheckSquare } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-purple-50/30 to-white">
      <div className="p-6 max-w-[1600px] mx-auto space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-white/80 text-sm">
                  {project.allTasks.length} tasks in total
                </p>
              </div>
            </div>
        ...
        <div className="space-y-4 animate-fadeInUp">
          {project.allTasks.map((task, index) => {
              ...
              >
                <CardContent className="p-0">
                  <div className="flex items-start gap-0">
                    ...
                    >
                      {isExpanded ? (
                        <ChevronDown className="w-5 h-5 text-purple-600 group-hover:scale-110 transition-transform duration-300" />
                      ) : (
                        <ChevronRight className="w-5 h-5 text-gray-400 group-hover:text-purple-600 group-hover:scale-110 transition-all duration-300" />
                      )}
                    </button>
                              ...
                              {task.subtasks.map((subtask, subIndex) => (
                                ...
                                >
                                  <input
                                    ...
                                    className="w-5 h-5 rounded border-2 border-purple-300 text-purple-600 focus:ring-2 focus:ring-purple-500"
                                    readOnly
                                  />
