                                          ...
                                          <TooltipProvider>
                                             <Tooltip delayDuration={300}>
                                                <TooltipTrigger asChild>
                                                   ...
                                                   <span
                                                      onClick={(e) => {
                                                         e.stopPropagation(); // Tránh kích hoạt toggle status nếu click vào chữ
                                                         if (onViewDetail) onViewDetail(sub.id);
                                                      }}
                                                      className={`truncate text-slate-700 font-medium text-sm block w-full hover:text-blue-600 hover:underline cursor-pointer ${sub.status === 'DONE' ? 'line-through text-slate-400' : ''}`}
                                                   >
