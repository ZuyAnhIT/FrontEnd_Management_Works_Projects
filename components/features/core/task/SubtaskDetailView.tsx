...
export default function SubtaskDetailView({
  ...
  const handleUpdate = async (field: keyof Subtask, value: any) => {
    ...
    // Chuyển assigneeId = 0 về null (Logic nghiệp vụ quan trọng)
    ...
    try {
      ...
      // NOTE: Logic revert optimistic UI có thể được thêm vào đây
    } finally {
      setIsSaving(false);
    }
  };
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-8 border-r border-slate-100">
          <div className="space-y-6">
            ...
            {/* Thêm Comment Section ở đây nếu cần */}
          </div>
        </div>
        ...
        <div className="w-[320px] bg-slate-50/50 overflow-y-auto custom-scrollbar p-6 space-y-6 shrink-0">
          ...
          <div className="space-y-3">
            ...
            {/* Custom Select Box cho Assignee */}
              ...
              <div className="flex items-center gap-2">
                <Avatar className="w-6 h-6">
                  <AvatarImage
                    ...
                    alt={subtask.assigneeName || "Unassigned"}
                  />
                  <AvatarFallback className="text-[10px] bg-blue-100 text-blue-700">
                    {subtask.assigneeName?.substring(0, 2).toUpperCase() ||
                      "UN"}
                  </AvatarFallback>
                </Avatar>
