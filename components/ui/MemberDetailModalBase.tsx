...
import { X, Loader2, CheckCircle2, Clock, XCircle, User } from "lucide-react";
import React from "react";
import { Button } from "@/components/ui/Buttons"; // Giả sử bạn có component Button chuẩn
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-5">
                ...
                <div className="relative w-20 h-20 rounded-full border border-slate-200 p-1 bg-white shadow-sm shrink-0">
                  {/* Sử dụng member.avatarUrl hoặc fallback URL */}
                  <img
                    src={
                      member.avatarUrl ||
                  ...
                  return (
                    <div key={field.key} className="space-y-1">
                      ...
                      <div className="text-sm font-medium text-slate-900 break-words">
                        {/* Logic Render tùy chỉnh hoặc Format Date */}
                        {field.render
