...
interface FilterPopoverProps {
  label: string;       // Tên bộ lọc (VD: Assignee)
...
export default function FilterPopover({ label, icon, options, value, onChange }: FilterPopoverProps) {
  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      {/* Menu thả xuống */}
      {isOpen && (
        <div className="absolute top-full left-0 mt-2 w-56 bg-white border border-slate-200 rounded-xl shadow-xl z-50 animate-in fade-in zoom-in-95 overflow-hidden">
